...
public class ApiClient {
    ...
    private String basePath = "http://api.bitpool.com:80";
    ...
    public ApiClient() {
        ...
        authentications.put("api", new ApiKeyAuth("header", "Authorization"));
    ...
    */
    ...
    private ClientResponse getAPIResponse(String path, String method, List<Pair> queryParams,
                                          Object body, byte[] binaryBody, Map<String, String> headerParams,
